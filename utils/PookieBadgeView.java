 ...
 * 
 */
public class PookieBadgeView extends TextView {
	...
	public PookieBadgeView(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}
	
	public PookieBadgeView(Context context, AttributeSet attrs) {
     ...
     * Constructor -
     * 
     * create a new PookieBadgeView instance attached to a target {@link View}.
     *
     * @param context context for this view.
     * @param target the View to attach the badge to.
     */
	public PookieBadgeView(Context context, View target) {
     ...
     * Constructor -
     * 
     * create a new PookieBadgeView instance attached to a target {@link TabWidget}
     ...
     */
	public PookieBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public PookieBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public PookieBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
